...
parser.add_argument('--eval_name', type=str, help='Name for evaluation run', default='Eval:Default')
parser.add_argument('--plot_options', type=str, help='Plotting mode (first, none, all, or first10)', default='first10')
parser.add_argument('--sampledir', type=str, help='relative path to directory where samples from the numerical experiment were stored')
parser.add_argument('--gtdir', type=str, help='relative path to directory where ground-truth samples from the numerical experiment of interest were stored')
...
if exper_type == 'phase_retrieval':
    ...
    eval_ops.mmd_kernel_bandwidth = 2.0774
    eval_ops.cmd_decay_rate = 4.7307
