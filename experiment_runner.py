...
parser.add_argument('--resultsfolder', type=str, help='Directory within which results folder will be created', default='results')
parser.add_argument('--exper_name', type=str, help='Name of experiment', default='MyExperiment')
parser.add_argument('--seed', type=int, help='Seed (default = 0)', default=0)
parser.add_argument('--verbose', type=bool, help='Seed (default = 0)', default=False)
parser.add_argument('--num_trials', type=int, help='Number of trials to run (default = 1)', default=1)
parser.add_argument('--bipsda_sampler', type=str, help='Sampler (Lang, MAP, or RTO)')
parser.add_argument('--denoising_model', type=str, help='Model of denoising distribution (TC, TU, or ODE)')

# parse arguments
passed_args = parser.parse_args()

# get arguments
resultsfolder = passed_args.resultsfolder
...
# run
run_mixture_sampling(args, config, resultsfolder)